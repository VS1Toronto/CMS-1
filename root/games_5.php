...
<div id="gamePageMiddle">
        ...
        <div id="pageMiddle_Game_Container" style="width:100%">
            <div class="flip3Dclick">
                <div class="back" onclick="flipit(this.parentNode, false);"><img src="images/games/code_blue_back.png" alt="code_blue_back_image" width="1000" height="400"></div>
                <div class="front" onclick="flipit(this.parentNode, true);"><img src="images/games/code_blue_one.png" alt="code_blue_image" width="1000" height="400"></div>
            </div>
            </br>
            </br>
            </br>
	        ...
	        <div><a id="download_button_1"<a class="button_bar" href="https://1drv.ms/f/s!AthsCUt5GHHImzHu7pd8FI2ASSbr" title="link to Code Blue download" style="height:20px; width:100px">Download</div></h3></a>
            </br>
            <a id="croc_runner_showcase" target="_blank"><img src="images/games/code_blue_showcase.png" alt="code_blue_showcase_image" width="500" height="400"></a>
