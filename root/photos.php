...
if(isset($_GET["u"])){
    ...
    header("http://leedavidsoncontentmanagementsystem1.com/cms_1/root/index.php");
    exit();	
}
$photo_form = "";
...
if($u == $log_username && $user_ok == true){
	...
	$photo_form .=     '<option value="Events">Events</option>';
	$photo_form .=     '<option value="Holidays">Holidays</option>';
	$photo_form .=     '<option value="Nights Out">Nights Out</option>';
	$photo_form .=     '<option value="Other Stuff">Other Stuff</option>';
	$photo_form .=   '</select>';
...
<style type="text/css">
form#photo_form{background:; border:#1a92c2 1px solid; padding:20px; width:1000px }
div#galleries{}
div#galleries > div{float:left; margin:20px; text-align:center; cursor:pointer;}
div#galleries > div > div {height:200px; margin:20px; overflow:hidden;} 
div#galleries > div > div > img{width:150px; cursor:pointer;}
div#photos{display:none; border:#1a92c2 1px solid; padding:20px;}
div#photos > div{float:left; width:125px; height:150px; overflow:hidden; margin:20px;}
