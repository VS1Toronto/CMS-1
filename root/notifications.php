...
<style type="text/css">
div#notesBox{float:left; width:430px; border:#1a92c2 1px solid; margin-right:60px; padding:10px;}
div#friendReqBox{float:left; width:430px; border:#1a92c2 1px solid; padding:10px;}
