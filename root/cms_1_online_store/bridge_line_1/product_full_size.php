...
<div id="table1" >
    <table width="100%" cellspacing="0" cellpadding="10">
        <tr>
                    ...
                    <div>&nbsp;&nbsp;&nbsp;<?php echo 'Click here to return to main menu , <a href="index.php">click here</a>' ?>;</div>
            <td width="32%" valign="top"><img src="inventory_images/<?php echo $id; ?>.jpg" width="950" height="950" alt="$product_name" /></br>
                </br>
                </br>
                    <?php echo 'Click here to return to main menu , <a href="index.php">click here</a>' ?>;
        </tr>
    </table>
</div>       
