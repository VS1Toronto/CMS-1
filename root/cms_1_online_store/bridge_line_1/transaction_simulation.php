...
<div id="table1" >
  ...
  <tr>
    ...
    <td width="35%" valign="top">
            ...
            <p>This website has had its Paypal button deactivated preventing ordering of goods as this site is a 
               demonstrator and although it can be made live for small business use very quickly it's function really
               is to demonstrate its code.
               
               To show the sites capabilities an entire user journey has been created on the Behance Portfolio website which
            ...
            <p>
                <?php echo 'Click here for the Behance Portfolio page , <a href="https://www.behance.net/gallery/59211895/CMS-1-Paypal-Store">click here</a>' ?>;
            </p>
            </br>
            </br>
            </br>
            ...
            <p>
                <?php echo 'Click here to return to main index page , <a href="index.php">click here</a>' ?>;
            </p>
    </td>
