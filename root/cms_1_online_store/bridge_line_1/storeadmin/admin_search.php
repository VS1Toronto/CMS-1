    ...
    while($row = mysqli_fetch_array($query)){
        ...
        <tr>
            <td width=18%" valign="top">
                <a href="product.php?id=' . $id . '"><img style="border:#000000 1px solid;" src="http://leedavidsoncontentmanagementsystem1.com/cms_1/root/cms_1_online_store/bridge_line_1/inventory_images/' . $id . '.jpg" alt="' . $product_name . '" width="77" height=102" border="1" /></a>
            </td>
