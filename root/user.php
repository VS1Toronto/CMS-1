...
if($u == $log_username && $user_ok == true){
	...
	$avatar_form .=   '<h4>Best 800px 800px</h4>';
...
<style type="text/css">
div#avatar_form{float:right; border:#999 2px solid; width:200px; height:200px; margin:20px 30px 0px 0px; overflow-y:hidden;}
...
div#photo_showcase{float:right; background:url(style/photo_showcase.png) no-repeat; width:136px; height:250px; margin:20px 30px 0px 0px; cursor:pointer;}
div#photo_showcase > img{width:74px; height:74px; margin:37.5px 0px 0px 30px;}
img.friendpics{border:#000 1px solid; width:40px; height:40px; margin:2px;}
div#friendsHTML{height:2500px;}
</style>
<style type="text/css">
textarea#statustext{width:982px; height:80px; padding:8px; border:#1a92c2 1px solid; font-size:16px;}
div.status_boxes{padding:12px; line-height:1.5em;}
div.status_boxes > div{padding:8px;  border:#EDEBEBpx solid; background: #f2f5f6;}
div.status_boxes > div > b{font-size:12px;}
div.status_boxes > button{padding:5px; font-size:12px;}
textarea.replytext{width:98%; height:40px; padding:1%; border:#1a92c2 1px solid;}
div.reply_boxes{padding:12px; border:#EDEBEB 1px solid; background:#F5F5F5;}
