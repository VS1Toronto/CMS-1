...
<div id="gamePageMiddle">
        ...
        <div id="pageMiddle_Game_Container" style="width:100%">
            <div class="flip3Dclick">
                <div class="back" onclick="flipit(this.parentNode, false);"><img src="images/games/the_break_up_back.png" alt="the_break_up_back_image" width="1000" height="400"></div>
                <div class="front" onclick="flipit(this.parentNode, true);"><img src="images/games/angry_woman.png" alt="the_break_up_image" width="1000" height="400"></div>
            </div>
            </br>
            </br>
            </br>
	        ...
	        <div><a id="download_button_1"<a class="button_bar" href="https://1drv.ms/u/s!AthsCUt5GHHImyw7suExxE18AEI_" title="link to The Break Up download" style="height:20px; width:100px">Download</div></h3></a>
            </br>
            <a id="the_break_up_showcase" target="_blank"><img src="images/games/the_break_showcase.png" alt="the_break_up_showcase_image" width="500" height="400"></a>
